    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Customer>().HasData(
                new Customer() { ID = 1, Name = "Nguyễn Công Tiến", Phone = "0987654321", Sex = true, Address = " 10 Minh Khai, Hà Nội", Point=0 },
                new Customer() { ID = 2, Name = "Nguyễn Mạnh Thắng", Phone = "0987777777", Sex = true, Address = " 69 Trịnh Văn Bô, Hà Nội", Point = 0 }
                );
